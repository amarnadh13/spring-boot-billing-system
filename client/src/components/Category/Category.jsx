...
const Category = ({categoryName, imgUrl, numberOfItems, isSelected, onClick}) => {
    return (
        <div className="d-flex align-items-center p-3 rounded gap-1 position-relative category-hover"
            ...
            <div>
                <h6 className="text-black mb-0">{categoryName}</h6>
                <p className="text-black mb-0">{numberOfItems} Items</p>
            </div>
